<template>
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="32"
        height="32" x="0" y="0" viewBox="0 0 404.009 404.009" style="enable-background:new 0 0 512 512"
        ...
        <g>
            ...
            <path
                ...
                fill="#fff" opacity="1" data-original="#fff" class=""></path>
            <ellipse cx="155.152" cy="155.669" rx="18.988" ry="18.978" fill="#fff" opacity="1"
                data-original="#fff" class=""></ellipse>
            <ellipse cx="85.196" cy="155.669" rx="18.988" ry="18.978" fill="#fff" opacity="1" data-original="#fff"
                class=""></ellipse>
            <ellipse cx="225.109" cy="155.669" rx="18.988" ry="18.978" fill="#fff" opacity="1"
                data-original="#fff" class=""></ellipse>
        </g>
    </svg>
